...
object Dependencies {
  ...
  val PekkoGrpc: Seq[ModuleID] = Seq(
    ...
    "org.apache.pekko" %% "pekko-grpc-runtime" % V.PekkoGrpc excludeAll ExclusionRule(organization = "org.apache.pekko"),
  ...
  val Client: Seq[ModuleID] = PekkoGrpc ++ Seq() ++ Commons
